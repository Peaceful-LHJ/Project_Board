...
<div class="container">
		...
		<div class="col-12">
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="getBtns">
						<sec:authorize access="isAuthenticated() and principal.username == #board.writer or hasRole('ROLE_ADMIN')"> <!-- 인증된 사용자이고, 인증된 사용자가 글작성자와 일치하거나 권한이 어드민인 경우 접근가능하다 -->
						<button data-oper='modify' class="btn btn-light modify">Modify</button> <!-- #authInfo.memberId == principal.username 둘이 같음ㅇㅇ -->
						</sec:authorize>
	...
	<div class="my-3 replyWriterForm">
		<sec:authorize access="isAnonymous()">
			<textarea rows="6" placeholder="로그인한 사용자만 댓글을 작성할 수 있습니다."
